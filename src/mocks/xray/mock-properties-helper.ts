...
export class MockPropertiesHelper extends MockLuabindClass implements properties_helper {
  ...
  public create_bool = jest.fn((...args: Array<unknown>) => args) as unknown as jest.MockedFunction<
    properties_helper["create_bool"]
  >;
  ...
  public vector_on_before_edit = jest.fn() as unknown as jest.MockedFunction<
    properties_helper["vector_on_before_edit"]
  >;
